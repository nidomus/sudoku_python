...
class App():
    def __init__(self, master) -> None:
        ...
        self.btn_resolver = tk.Button(self.frames_botoes, text='Resolver', font=(
            'Arial', 35), command=lambda: Thread(target=self.resolver_jogo).start())
        ...
        for q in range(3):
            ...
            for i in range(3):
                ...
                for j in range(3):
                    ...
                    btn = tk.Button(frame_btns, text='  ', width=3,
        ...
        for q in range(3, 6):
            ...
            for i in range(3):
                ...
                for j in range(3):
                    ...
                    btn = tk.Button(frame_btns, background='white',
                                    text='  ', width=3, font=('Arial', 35))
                    botoes.append(btn)
                    btn.bind('<Button-1>', lambda event, btn=btn, coord=(i, j),
                             quad=frame_quad: self.selecionado(btn, coord, quad))
                    btn.pack(side=LEFT)
        ...
        for q in range(6, 9):
            ...
            for i in range(3):
                ...
                for j in range(3):
                    ...
                    btn = tk.Button(
                        frame_btns, text='  ', background='white', width=3, font=('Arial', 35))
                    botoes.append(btn)
    ...
    def restaurar_botoes_invalidos(self, valor, quad, linha, coluna):
        ...
        for q, i, j in self.tabuleiro.encontrar_valores_invalidos(quad, valor, linha, coluna):
            ...
            if botao['state'] == 'disabled':
                ...
                coord.append((q, i, j))
            botao.configure(
                fg='black', disabledforeground='#8A8771', bg=cor_de_fundo)
        ...
        for i in range(9):
            for linha in range(3):
                for coluna in range(3):
                    ...
                    self.quadrantes_botoes[i][linha][coluna].configure(
                        text=valor, state='disabled', bg='white')
                    self.quadrantes_botoes[i][linha][coluna].unbind(
                        '<Button-1>')
